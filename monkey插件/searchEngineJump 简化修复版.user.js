...
// @include        /^https?:\/\/(www\.)?btso\.pw\/search/
...
// @include        /^https?:\/\/(www\.)?torrentkitty\.(com|org|net|tv)\/search\//
...
//    },
    ...
    {name: "知乎",
        ...
        ',
        insertIntoDoc: {
            keyword: 'css;.Popover input',//keyword: 'css;input#q',   //
            target: 'css;body',    //target:'cdd;.SearchTabs-inner',//
            where: 'beforeBegin'
        },
...
//    },
    ...
    {name: "bilibili",
        ...
        insertIntoDoc: {
           ...
           target: 'css;div#server-search-app',
           where: 'beforeBegin',
        },
    },
    {name: "acfan",
    ...
    {name: "youtube",
        ...
        insertIntoDoc: {
           ...
           target: 'css;div#masthead-container',
           where: 'afterBegin',
        },
    },
    {name: "niconico",
...
function run() {
    ...
    console.log('插入的位置为 %o', iTarget,matchedRule.insertIntoDoc.target);
    console.log('匹配的输入框为 %o', iInput,matchedRule.insertIntoDoc.keyword);

    if (!iTarget || !iInput) {
        debug('不存在插入的位置或匹配的输入框', iTarget, iInput);
        console.log('不存在插入的位置或匹配的输入框', iTarget, iInput);
        return;
    }
...
console.log("ttttttttttttttttttttt",window.self != window.top);
// iframe 禁止加载
...
rules.some(function (rule) {
     console.log(rule.url,toRE(rule.url));
